...
# Specified the methods that are supported by vLLM. This is used to filter out unsupported methods when using vLLM for inference.
VLLM_SUPPORTED_METHODS = ['caa', 'vector_prompt', 'sta', 'sae_feature']